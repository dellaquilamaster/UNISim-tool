...
* OSCAR (An OSCAR telescope) -> options: -distance (perpendicular distance from the target), -theta (polar angle of the center in degrees), -phi (azimuthal angle of the center in degrees), -strip (yes or no, to include or not the strip layer)
