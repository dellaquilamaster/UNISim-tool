...
OBJS      := $(ObjDir)TDetectionSetup.$(ObjSuf) $(ObjDir)TDetectionUnit.$(ObjSuf) $(ObjDir)TStripDetector.$(ObjSuf) $(ObjDir)TLampWedgeDetector.$(ObjSuf) $(ObjDir)EnergyLossModule.$(ObjSuf) $(ObjDir)nuclear_masses.$(ObjSuf) $(ObjDir)RelativisticKinematics.$(ObjSuf) $(ObjDir)UNISRootEvent.$(ObjSuf) $(ObjDir)UNISEventGenerator.$(ObjSuf) $(ObjDir)UNISSequentialDecay.$(ObjSuf) $(ObjDir)UNISFramework.$(ObjSuf) $(ObjDir)$(UNISROOTEVENT_DICTO) $(ObjDir)shared.$(ObjSuf)
...
$(ObjDir)TDetectionSetup.$(ObjSuf): ./detectors/DetectionSetup/TDetectionSetup.cpp  ./detectors/DetectionSetup/TDetectionSetup.h
	$(CXX) $(CXXFLAGS) -c  ./detectors/DetectionSetup/TDetectionSetup.cpp -o $(ObjDir)TDetectionSetup.$(ObjSuf) $(SYSLIB) $(CFLAGS) $(RLIBS)	
	
$(ObjDir)TDetectionUnit.$(ObjSuf): ./detectors/DetectionSetup/TDetectionUnit.cpp  ./detectors/DetectionSetup/TDetectionUnit.h
	$(CXX) $(CXXFLAGS) -c  ./detectors/DetectionSetup/TDetectionUnit.cpp -o $(ObjDir)TDetectionUnit.$(ObjSuf) $(SYSLIB) $(CFLAGS) $(RLIBS)	
	
$(ObjDir)TStripDetector.$(ObjSuf): ./detectors/Strip/TStripDetector.cpp  ./detectors/Strip/TStripDetector.h
	$(CXX) $(CXXFLAGS) -c  ./detectors/Strip/TStripDetector.cpp -o $(ObjDir)TStripDetector.$(ObjSuf) $(SYSLIB) $(CFLAGS) $(RLIBS)	
	
$(ObjDir)TLampWedgeDetector.$(ObjSuf): ./detectors/Lamp/TLampWedgeDetector.cpp  ./detectors/Lamp/TLampWedgeDetector.h
	$(CXX) $(CXXFLAGS) -c  ./detectors/Lamp/TLampWedgeDetector.cpp -o $(ObjDir)TLampWedgeDetector.$(ObjSuf) $(SYSLIB) $(CFLAGS) $(RLIBS)	

$(ObjDir)EnergyLossModule.$(ObjSuf):  ./LISETools/EnergyLossModule.cpp  ./LISETools/EnergyLossModule.h
	$(CXX) $(CXXFLAGS) -c ./LISETools/EnergyLossModule.cpp -o $(ObjDir)EnergyLossModule.$(ObjSuf) $(SYSLIB) $(CFLAGS) $(RLIBS)

$(ObjDir)nuclear_masses.$(ObjSuf):  ./LISETools/nuclear_masses.cpp  ./LISETools/nuclear_masses.h
	$(CXX) $(CXXFLAGS) -c ./LISETools/nuclear_masses.cpp -o $(ObjDir)nuclear_masses.$(ObjSuf) $(SYSLIB) $(CFLAGS) $(RLIBS)

$(ObjDir)RelativisticKinematics.$(ObjSuf):  ./LISETools/RelativisticKinematics.cpp  ./LISETools/RelativisticKinematics.h
	$(CXX) $(CXXFLAGS) -c ./LISETools/RelativisticKinematics.cpp -o $(ObjDir)RelativisticKinematics.$(ObjSuf) $(SYSLIB) $(CFLAGS) $(RLIBS)

$(ObjDir)UNISFramework.$(ObjSuf):  ./$(SrcDir)UNISFramework.cpp  ./$(DepDir)UNISFramework.h
	$(CXX) $(CXXFLAGS) -c ./$(SrcDir)UNISFramework.cpp -o $(ObjDir)UNISFramework.$(ObjSuf) $(SYSLIB) $(CFLAGS) $(RLIBS)
	
$(ObjDir)shared.$(ObjSuf):  ./$(SrcDir)shared.cpp  ./$(DepDir)shared.h
	$(CXX) $(CXXFLAGS) -c ./$(SrcDir)shared.cpp -o $(ObjDir)shared.$(ObjSuf) $(SYSLIB) $(CFLAGS) $(RLIBS)
	
$(ObjDir)UNISEventGenerator.$(ObjSuf):  ./generator/UNISEventGenerator.cpp  ./generator/UNISEventGenerator.h
	$(CXX) $(CXXFLAGS) -c ./generator/UNISEventGenerator.cpp -o $(ObjDir)UNISEventGenerator.$(ObjSuf) $(SYSLIB) $(CFLAGS) $(RLIBS)
	
$(ObjDir)UNISSequentialDecay.$(ObjSuf):  ./generator/UNISSequentialDecay.cpp  ./generator/UNISSequentialDecay.h
	$(CXX) $(CXXFLAGS) -c ./generator/UNISSequentialDecay.cpp -o $(ObjDir)UNISSequentialDecay.$(ObjSuf) $(SYSLIB) $(CFLAGS) $(RLIBS)

$(ObjDir)UNISRootEvent.$(ObjSuf):  ./$(SrcDir)UNISRootEvent.cpp  ./$(DepDir)UNISRootEvent.h ./$(ObjDir)$(UNISROOTEVENT_DICTO)
	$(CXX) $(CXXFLAGS) -c ./$(SrcDir)UNISRootEvent.cpp -o $(ObjDir)UNISRootEvent.$(ObjSuf) $(SYSLIB) $(CFLAGS) $(RLIBS)
	
$(ObjDir)$(UNISROOTEVENT_DICTO):  ./$(UNISROOTEVENT_DICT)
	$(CXX) $(CXXFLAGS) -c ./$(UNISROOTEVENT_DICT) -o ./$(ObjDir)$(UNISROOTEVENT_DICTO) $(SYSLIB) $(CFLAGS) $(RLIBS)
